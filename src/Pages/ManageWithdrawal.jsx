...
const ManageWithdrawal = () => {
  ...
  const sendSignUpEmail = async (id) => {
    const urlemail = `https://okx-assetsbackend.onrender.com/api/confirmwithdrawalemailsend/${id}`
    axios.post(urlemail)
       .then(response => {
    ...
    const acceptDeposit = (withdrawId) => {
        const url = `https://okx-assets-back-end.vercel.app/api/confirm-withdrawal/${withdrawId}`;
        axios.post(url)
            .then((response) => {
    ...
    const getallDeposit = () => {
        const url = "https://okx-assets-back-end.vercel.app/api/allwithdrawal";
        axios.get(url)
            .then((response) => {
